...
ui <- fluidPage(
  tags$head(
    ...
    tags$script(src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.14.0-beta2/js/bootstrap-select.min.js"),
    ...
    tags$link(href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.14.0-beta2/css/bootstrap-select.min.css", rel = "stylesheet", type="text/css"),
