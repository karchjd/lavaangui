...
#generate data according to the linear growth model
b0 <- 3
b1 <- 2
...
#residual variances, i.e., parasLM[3] and gpModel$mlParas[3] are not the same because GPPM uses ML for parameter estimation and lm OLS
